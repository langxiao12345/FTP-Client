...
public:
	...
	virtual void OnConnectionClosed(const char *pszIP, unsigned int nPort, REMOVE_REASON rr, __int64 nByteSent, unsigned int nTimeUsed);
	...
	virtual void OnRequested(const char *pszIP, unsigned int nPort, const char *pszUrl, HTTP_METHOD hm, SERVER_CODE sc);
