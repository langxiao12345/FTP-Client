...
const char* g_HTTP_Content_NotFound = "<html><head><title>s HTTP Server -  C++ Studio</title></head><body>404 Not Found</body></html>";
const char* g_HTTP_Bad_Request = "400 Bad Request - HTTP Server";
const char* g_HTTP_Bad_Method = "405 Method Not Allowed -  HTTP Server";
const char* g_HTTP_Server_Error = "500 Opps, server error! -  HTTP Server";
const char* g_HTTP_Forbidden = "403 Forbidden -  HTTP Server";
const char *g_HTTP_Head = "http://localhost/";
